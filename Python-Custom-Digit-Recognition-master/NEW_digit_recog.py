...
digits, labels = load_digits_custom('train_cv_img.jpg') #my handwritten dataset
...
print('KNN_Accuracy: ',accuracy_score(y_test, preds))
...
model.train(X_train, y_train)
preds = model.predict(X_test)
print('SVM _Accuracy: ',accuracy_score(y_test, preds))
